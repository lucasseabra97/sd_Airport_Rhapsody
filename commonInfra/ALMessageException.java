...
public class ALMessageException extends Exception
{
  /**
   ...
   */
   ...
   private ArraivalLoungeMessage msg;
   ...
   */
   ...
   public ALMessageException (String errorMessage, ArraivalLoungeMessage msg)
   {
     super (errorMessage);
     this.msg = msg;
   }
   ...
   */
   ...
   public ArraivalLoungeMessage getMessageVal ()
   {
     return (msg);
   }
}
